...
- 저장 즉시 본인의 관리자 세션과 MCP 연결·진행 중 로그인을 폐기합니다. 새 정보로 다시 로그인하고 ChatGPT 법령 MCP도 재연결하세요. 다른 직원 연결은 유지됩니다. 기존 사용량은 새 아이디로 이어지며 관리 기록은 작업 당시 아이디를 유지합니다. 이전 아이디는 재사용할 수 없습니다.
